...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($errorMsg === '') {
        try {
            $sql = "INSERT INTO ho_senior_managers_fuel_acl_cables
            ...
            header("Location: diesel_senior_acl_cables_ho.php?success=1&year={$qYear}&month={$qMonth}&litres={$qLitres}");
            exit;
...
<head>
    ...
    <title>Monthly Fuel Consumption – Senior Executive Vehicles (ACL Cables PLC Head Office)</title>
