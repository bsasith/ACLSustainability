...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_id'])) {
    ...
    if ($deleteId > 0) {
        $stmt = $conn->prepare("DELETE FROM ho_distribution_fuel_acl_cables WHERE id = ?");
...
<head>
    ...
    <title>Fuel Consumption – Distribution Vehicles Head Office (View Data)</title>
        ...
        <div class="card card-ui mb-3">
            <div class="card-body d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="diesel_distribution_acl_cables_ho.php" class="btn btn-success">
                            ...
                            <tbody>
                                <?php foreach ($data as $row): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="diesel_distribution_acl_cables_ho_edit_form.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm btn-ghost">
