...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($errorMsg === '') {
        try {
            $sql = "UPDATE ho_distribution_fuel_acl_cables
                    SET report_month = ?, 
                        report_year = ?, 
                        fuel_litres = ?, 
                        updated_at = NOW()
            ...
            header("Location: diesel_distribution_acl_cables_ho_edit_form.php?id={$id}&success=1");
            exit;
...
<title>Edit Fuel Consumption – Distribution Vehicles Head Office</title>
...
<div class="card form-card">
    <div class="form-header">
        <h2 class="form-title">
            ...
            Edit Monthly Fuel Consumption – Distribution Vehicles Head Office
        </h2>
        <div class="form-sub">
    ...
    <div class="card-body">
        <form method="post">
            ...
            <div class="d-flex justify-content-end gap-2">
                <a href="diesel_distribution_acl_cables_ho_view_edit.php" class="btn btn-outline-secondary btn-submit">
