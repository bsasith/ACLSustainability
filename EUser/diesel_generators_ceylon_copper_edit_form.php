...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($errorMsg === '') {
        try {
            $sql = "UPDATE diesel_generators_ceylon_copper
                    SET report_month = ?, 
                        report_year = ?, 
                        diesel_litres = ?, 
                        updated_at = NOW()
            ...
            header("Location: diesel_generators_ceylon_copper_edit_form.php?id={$id}&success=1");
            exit;
...
<title>Edit Diesel Consumption – Diesel Generators</title>
...
<div class="card form-card">
    <div class="form-header">
        <h2 class="form-title">
            ...
            Edit Monthly Diesel Consumption – Diesel Generators
        </h2>
        <div class="form-sub">
