...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($errorMsg === '') {
        try {
            $sql = "UPDATE electricity_acl_cables
                    SET report_month = ?, 
                        report_year = ?, 
                        electricity_kwh = ?, 
                        updated_at = NOW()
            ...
            header("Location: electricity_acl_cables_edit_form.php?id={$id}&success=1");
            exit;
...
<title>Edit Electricity Consumption – ACL Cables PLC</title>
...
<div class="card form-card">
    <div class="form-header">
        <h2 class="form-title">
            ...
            Edit Monthly Electricity Consumption – ACL Cables PLC
        </h2>
        <div class="form-sub">
    ...
    <div class="card-body">
        <form method="post">
            ...
            <div class="d-flex justify-content-end gap-2">
                <a href="electricity_acl_cables_view_edit.php" class="btn btn-outline-secondary btn-submit">
