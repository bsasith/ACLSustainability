...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($errorMsg === '') {
        try {
            $sql = "INSERT INTO electricity_acl_cables
            ...
            header("Location: electricity_acl_cables.php?success=1&year={$qYear}&month={$qMonth}&litres={$qLitres}");
            exit;
...
<head>
    ...
    <title>Monthly Electricity Consumption – ACL Cables PLC</title>
