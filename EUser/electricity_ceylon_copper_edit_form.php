...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($errorMsg === '') {
        try {
            $sql = "UPDATE electricity_ceylon_copper
                    SET report_month = ?, 
                        report_year = ?, 
                        electricity_kwh = ?, 
                        updated_at = NOW()
            ...
            header("Location: electricity_ceylon_copper_edit_form.php?id={$id}&success=1");
            exit;
...
<title>Edit Electricity Consumption – Ceylon Copper</title>
...
<div class="card form-card">
    <div class="form-header">
        <h2 class="form-title">
            ...
            Edit Monthly Electricity Consumption – Ceylon Copper
        </h2>
        <div class="form-sub">
            Ceylon Copper PLC | Scope 2 – Indirect GHG Emissions
        </div>
    </div>
    ...
    <div class="card-body">
        <form method="post">
            ...
            <div class="d-flex justify-content-end gap-2">
                <a href="electricity_ceylon_copper_view_edit.php" class="btn btn-outline-secondary btn-submit">
