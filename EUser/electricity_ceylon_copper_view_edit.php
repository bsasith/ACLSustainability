...
<title>Electricity Consumption – Ceylon Copper (View Data)</title>
        ...
        <div class="card-body d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div>
                <h4 class="mb-1 fw-bold">
                    <i class="bi bi-building-fill-check text-danger"></i>
                    Monthly Electricity Consumption – Ceylon Copper 
                </h4>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="electricity_ceylon_copper.php" class="btn btn-success">
