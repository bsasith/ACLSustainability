...
// --------------------
$sql = "SELECT report_month, report_year, electricity_kwh
        FROM electricity_acl_metals_alloys
        WHERE id = ?";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($errorMsg === '') {
        try {
            $sql = "UPDATE electricity_acl_metals_alloys
                    SET report_month = ?, 
                        report_year = ?, 
                        electricity_kwh = ?, 
                        updated_at = NOW()
            ...
            header("Location: electricity_acl_metals_edit_form.php?id={$id}&success=1");
            exit;
...
<title>Edit Electricity Consumption – ACL Metals & Alloys PLC</title>
...
<div class="card form-card">
    <div class="form-header">
        <h2 class="form-title">
            ...
            Edit Monthly Electricity Consumption – ACL Metals & Alloys PLC
        </h2>
        <div class="form-sub">
            ACL Metal & Alloys PLC | Scope 2 – Indirect GHG Emissions
        </div>
    </div>
        ...
        <form method="post">
            ...
            <div class="mb-4">
                ...
                <input type="number"
                       ...
                       step="0.01"
                       min="0"
                       value="<?php echo htmlspecialchars($row['electricity_kwh']); ?>"
                       required>
            </div>

            <div class="d-flex justify-content-end gap-2">
                <a href="electricity_acl_metals_view_edit.php" class="btn btn-outline-secondary btn-submit">
