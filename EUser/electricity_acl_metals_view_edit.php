...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_id'])) {
    ...
    if ($deleteId > 0) {
        $stmt = $conn->prepare("DELETE FROM electricity_acl_metals_alloys WHERE id = ?");
...
<title>Electricity Consumption – ACL Metals & Alloys (View Data)</title>
        ...
        <div class="card-body d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div>
                <h4 class="mb-1 fw-bold">
                    ...
                    <i class="bi bi-plug-fill text-danger"></i>
                    Monthly Electricity Consumption – ACL Metals & Alloys PLC
                </h4>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="electricity_acl_metals.php" class="btn btn-success">
                ...
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                               <a href="electricity_acl_metals_edit_form.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm btn-ghost">
