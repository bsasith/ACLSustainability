...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_id'])) {
    ...
    if ($deleteId > 0) {
        $stmt = $conn->prepare("DELETE FROM furnace_oil_acl_metals_alloys WHERE id = ?");
...
// $sql = "SELECT id,report_year, report_month, furnace_oil_litres, created_by, created_at
...
<title>Monthly Furnace Oil Consumption - ACL Metals & Alloys (View Data)</title>
        ...
        <div class="card-body d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div>
                <h4 class="mb-1 fw-bold">
                    ...
                    Monthly Furnace Oil Consumption 
                </h4>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="furnace_oil_acl_metals_alloys.php" class="btn btn-success">
                ...
                <table class="table table-hover align-middle">
                    <thead>
                        <tr>
                            ...
                            <th>Year</th>
                            <th>Month</th>
                            <th class="text-end">Furnace Oil (Litres)</th>
                            <th>Entered By</th>
                            <th>Date Entered</th>
                            <th>Edit/Delete</th>
                        </tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="fw-bold text-end">
                                <?php echo number_format($row['furnace_oil_litres'], 2); ?>
                            </td>
                            ...
                            <td>
                               <a href="furnace_oil_acl_metals_alloys_edit_form.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm btn-ghost">
