...
/**
 * ✅ KPI mapping (NO ALL option)
 * Each KPI table contains company_name, emission_scope, activity_type
 * (If you add solar later, it needs energy_type handling separately.)
 */
$KPI = [
    'diesel_boilers_acl_cables' => [
        'title' => 'Monthly Diesel Consumption – Steam Boilers',
    ...
    'diesel_forklifts_acl_cables' => [
        'title' => 'Monthly Diesel Consumption – Forklifts',
        'value_col' => 'diesel_litres',
        'unit' => 'Litres',
    ...
    'diesel_transport_logistics_acl_complex' => [
        'title' => 'Monthly Diesel Consumption – Transportation & Logistics',
        'value_col' => 'diesel_litres',
        'unit' => 'Litres',
        'icon' => 'bi-truck',
        'company_col' => 'company_name',
    ...
    'diesel_senior_vehicles_acl_complex' => [
        'title' => 'Monthly Diesel Consumption – Senior Executive Vehicles',
        'value_col' => 'diesel_litres',
        'unit' => 'Litres',
    ...
    'furnace_oil_acl_metals_alloys' => [
        'title' => 'Monthly Furnace Oil Consumption',
