...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($errorMsg === '') {
        try {
            $sql = "UPDATE diesel_boilers_acl_cables
                    SET report_month = ?, 
                        report_year = ?, 
                        diesel_litres = ?, 
                        updated_at = NOW()
            ...
            header("Location: diesel_boilers_acl_cables_edit_form.php?id={$id}&success=1");
            exit;
...
<title>Edit Diesel Consumption – Steam Boilers</title>
...
<div class="card form-card">
    <div class="form-header">
        <h2 class="form-title">
            ...
            Edit Monthly Diesel Consumption – Steam Boilers
        </h2>
        <div class="form-sub">
    ...
    <div class="card-body">
        <form method="post">
            ...
            <div class="d-flex justify-content-end gap-2">
                <a href="diesel_boilers_acl_cables_view_edit.php" class="btn btn-outline-secondary btn-submit">
