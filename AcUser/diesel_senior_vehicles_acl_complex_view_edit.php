...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_id'])) {
    ...
    if ($deleteId > 0) {
        $stmt = $conn->prepare("DELETE FROM diesel_senior_vehicles_acl_complex WHERE id = ?");
...
<title>Fuel Consumption – Senior Executive Vehicles (View Data)</title>
                ...
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                               <a href="diesel_senior_vehicles_acl_complex_edit_form.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm btn-ghost">
