...
$expectedUtype = basename(__DIR__); // "AcUser", "EUser", "HOUser"
$map = [
    'AcUser' => 'acuser',
    'EUser'  => 'euser',
    'HOUser' => 'houser',
    ...
    if (!csrf_validate($_POST['csrf'] ?? '')) {
        ...
        if ($current === '' || $new1 === '' || $new2 === '') {
            ...
            if (!$row || !password_verify($current, (string)$row['password_hash'])) {
                ...
                // Safer after password change
                session_regenerate_id(true);

                // PRG: show success page
...
<?php if ($success): ?>
<script>
  // go to dashboard.php after 1.5 seconds
  setTimeout(() => { window.location.href = "<?= e($dashboard) ?>"; }, 1500);
</script>
<?php endif; ?>
</head>
