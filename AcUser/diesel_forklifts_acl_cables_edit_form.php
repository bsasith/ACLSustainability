...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($errorMsg === '') {
        try {
            ...
            header("Location: diesel_forklifts_acl_cables_edit_form.php?id={$id}&success=1");
            exit;
...
<title>Edit Diesel Consumption – Forklifts</title>
...
<div class="card form-card">
    <div class="form-header">
        <h2 class="form-title">
            ...
            Edit Monthly Diesel Consumption – Forklifts
        </h2>
        <div class="form-sub">
    ...
    <div class="card-body">
        <form method="post">
            ...
            <div class="d-flex justify-content-end gap-2">
                <a href="diesel_forklifts_acl_cables_view_edit.php" class="btn btn-outline-secondary btn-submit">
